...
Function:
	getAllMessariCoins
Description:
	Fetch all coins from Messari API
---------------------------------------------------------*/
exports.getAllMessariCoins = async () => {
    let ret_list = [];
    return ret_list;
    ...
    allCoins.forEach((coin) => {
        ...
        scoin.msri.price = coin.metrics.market_data.price_usd ? coin.metrics.market_data.price_usd.toFixed(3) : null;
